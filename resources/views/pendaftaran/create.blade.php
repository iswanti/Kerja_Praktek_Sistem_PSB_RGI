    ...
    <div class="w-full mx-auto py-5 ">
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-500 px-8 py-6">
                <h1 class="text-2xl font-bold text-white tracking-tight">Formulir Pendaftaran</h1>
                <p class="text-blue-100 text-sm mt-1">Isi data pendaftaran Anda dengan benar dan lengkap</p>
            </div>
                    ...
                    <div class="space-y-10">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 flex items-center gap-6">
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input id="laki-laki" type="radio" name="jenis_kelamin" value="L" class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500" {{ old('jenis_kelamin') == 'L' ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">Laki-Laki</span>
                                        </label>
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input id="perempuan" type="radio" name="jenis_kelamin" value="P" class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500" {{ old('jenis_kelamin') == 'P' ? 'checked' : '' }}>
                                    ...
                                    <div>
                                        ...
                                        <select x-model="kelurahan" @change="pilihKelurahan()" class="w-full border-gray-300 rounded-xl shadow-sm text-sm py-2.5 focus:ring-2 focus:ring-blue-300 focus:border-blue-500 disabled:bg-gray-50 disabled:text-gray-400" :disabled="!kecamatan">
                                            ...
                                            <template x-for="kel in kelurahans" :key="kel.code">
                                                <option :value="kel.code" x-text="kel.name"></option>
                                            </template>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                                <div>
                                    ...
                                    <select name="pendidikan" class="w-full border-gray-300 rounded-xl shadow-sm text-sm py-2.5 focus:ring-2 focus:ring-blue-300 focus:border-blue-500">
                                        ...
                                        <option value="D4/S1" {{ old('pendidikan') == 'D4/S1' ? 'selected' : '' }}>Diploma 4 / S1</option>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                                ...
                                <div>
                                    ...
                                    <select name="pendidikan_wali" class="w-full border-gray-300 rounded-xl shadow-sm text-sm py-2.5 focus:ring-2 focus:ring-blue-300 focus:border-blue-500">
                                        ...
                                        <option value="SMA/SMK/MA" {{ old('pendidikan_wali') == 'SMA/SMK/MA' ? 'selected' : '' }}>SMA / SMK / MA</option>
                                        <option value="D1" {{ old('pendidikan_wali') == 'D1' ? 'selected' : '' }}>Diploma 1 (D1)</option>
                                        <option value="D2" {{ old('pendidikan_wali') == 'D2' ? 'selected' : '' }}>Diploma 2 (D2)</option>
                                        <option value="D3" {{ old('pendidikan_wali') == 'D3' ? 'selected' : '' }}>Diploma 3 (D3)</option>
                                        <option value="D4/S1" {{ old('pendidikan_wali') == 'D4/S1' ? 'selected' : '' }}>Diploma 4 / S1</option>
                                        <option value="S2" {{ old('pendidikan_wali') == 'S2' ? 'selected' : '' }}>S2 (Magister)</option>
                                        <option value="S3" {{ old('pendidikan_wali') == 'S3' ? 'selected' : '' }}>S3 (Doktor)</option>
                                    </select>
                                </div>
                                <div x-data="{ pekerjaan_wali: '{{ old('pekerjaan_wali') }}' }">
                                    ...
                                    <div x-show="pekerjaan_wali === 'Lainnya'" x-transition>
                                        <input type="text" name="pekerjaan_wali_lainnya" placeholder="Sebutkan pekerjaan lainnya..." class="mt-3 w-full border-gray-300 rounded-xl shadow-sm text-sm py-2.5 focus:ring-2 focus:ring-blue-300 focus:border-blue-500" value="{{ old('pekerjaan_wali_lainnya') }}">
                                    </div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <select name="pendidikan_ibu" class="w-full border-gray-300 rounded-xl shadow-sm text-sm py-2.5 focus:ring-2 focus:ring-blue-300 focus:border-blue-500">
                                        ...
                                        <option value="SMA/SMK/MA" {{ old('pendidikan_ibu') == 'SMA/SMK/MA' ? 'selected' : '' }}>SMA / SMK / MA</option>
                                        ...
                                        <option value="D4/S1" {{ old('pendidikan_ibu') == 'D4/S1' ? 'selected' : '' }}>Diploma 4 / S1</option>
                                        <option value="S2" {{ old('pendidikan_ibu') == 'S2' ? 'selected' : '' }}>S2 (Magister)</option>
                                        <option value="S3" {{ old('pendidikan_ibu') == 'S3' ? 'selected' : '' }}>S3 (Doktor)</option>
                                    </select>
                                </div>
                                <div x-data="{ pekerjaan_ibu: '{{ old('pekerjaan_ibu') }}' }">
                                    ...
                                    <div x-show="pekerjaan_ibu === 'Lainnya'" x-transition>
                                        <input type="text" name="pekerjaan_ibu_lainnya" placeholder="Sebutkan pekerjaan lainnya..." class="mt-3 w-full border-gray-300 rounded-xl shadow-sm text-sm py-2.5 focus:ring-2 focus:ring-blue-300 focus:border-blue-500" value="{{ old('pekerjaan_ibu_lainnya') }}">
                                    </div>
                                </div>
                                <div>
                        ...
                        <div class="border-t border-gray-100 pt-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                                ...
                                <div class="border border-gray-200 rounded-xl p-4 hover:border-blue-300 hover:bg-blue-50/30 transition-colors group">
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        {{ $doc['label'] }}
                                        @if($doc['required'])
                                    ...
                                    <input type="file" name="{{ $doc['name'] }}" class="w-full text-sm text-gray-500 file:mr-3 file:py-1.5 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer">
                                </div>
                                @endforeach
                            </div>
                        </div>
